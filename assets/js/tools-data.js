window.WA_TOOLS_CATALOG = [
  ...
  },
  {
    id: 'viral',
    name: '熱搜剛需',
    tagline: '發票對獎、房貸稅務、證件照與社群素材，搜得到也用得上。',
    tools: [
      {
      ...
      },
      {
        ...
        title: '房貸月付試算',
        icon: 'bi-house-door',
        desc: '本金利率年限，月付與總利息一次算清。',
        seoTitle: '房貸月付金試算｜本息攤還與總利息計算',
        seoDescription: '輸入貸款本金、年利率與年限，試算每月應繳、總利息與前十二期攤還明細，協助快速掌握房貸負擔。',
        seoKeywords: '房貸試算,月付金,本息攤還,房貸利率,Kawatool',
      },
      {
