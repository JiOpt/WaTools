    ...
    tools: [
      {
        ...
        seoTitle: 'IG 特殊字體產生器 | Kawatool',
        seoDescription: '純前端 Unicode 藝術字轉換，一鍵複製 IG／Threads 特殊字體，不上傳、不呼叫後端。',
        seoKeywords: 'IG字體,特殊字體,Unicode,Threads,Kawatool',
      },
      {
        ...
        seoTitle: '純前端圖片壓縮工具 | Kawatool',
        seoDescription: 'HTML5 Canvas 本地壓縮 JPEG／WebP，不上傳伺服器，省頻寬、護隱私。',
        seoKeywords: '圖片壓縮,Canvas,WebP,JPEG,Kawatool',
      },
      {
        ...
        seoTitle: '勞退金／勞保退休金試算器 | Kawatool',
        seoDescription: '輸入投保薪資、年資與提繳比例，Canvas 圖表呈現預估勞退與勞保老年給付。',
        seoKeywords: '勞退,勞保,退休金試算,Kawatool',
      },
      {
        ...
        seoTitle: 'IG／Threads 貼文排版空白字 | Kawatool',
        seoDescription: '自動將換行轉為社群專用空白字元，避免 IG／Threads 貼文排版跑版。',
        seoKeywords: 'IG排版,空白字,Threads,貼文,Kawatool',
      },
      {
        ...
        seoTitle: '微迷因梗圖產生器 | Kawatool',
        seoDescription: '預載經典迷因底圖，上下排文字 Canvas 即時渲染並下載。',
        seoKeywords: '迷因,梗圖,meme,Kawatool',
      },
      {
        ...
        seoTitle: 'LINE 傳圖防裁切預覽 | Kawatool',
        seoDescription: '將圖片調整為 1:1 或安全比例，預覽 LINE 聊天室裁切效果。',
        seoKeywords: 'LINE,圖片裁切,1:1,Kawatool',
      },
      {
        ...
        seoTitle: '乾淨 HTML 語意格式轉換器 | Kawatool',
        seoDescription: 'Markdown 轉乾淨語意 HTML，無 inline CSS，適合網誌貼上。',
        seoKeywords: 'Markdown,HTML,網誌,Kawatool',
      },
      {
        ...
        seoTitle: '高強度密碼產生器 | Kawatool',
        seoDescription: '使用 window.crypto.getRandomValues 產生密碼學安全隨機密碼。',
        seoKeywords: '密碼產生器,隨機密碼,crypto,Kawatool',
      },
      {
        ...
        seoTitle: '即時語音轉文字筆記本 | Kawatool',
        seoDescription: 'Web Speech API 語音記錄靈感，支援複製與匯出。',
        seoKeywords: '語音轉文字,筆記本,Web Speech,Kawatool',
      },
      {
        ...
        seoTitle: '高質感 QR Code 漸層美化 | Kawatool',
        seoDescription: '免外鏈 JS，純 Canvas 生成漸層圓角 QR Code。',
        seoKeywords: 'QR Code,漸層,美化,Kawatool',
      },
    ],
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        seoTitle: '日本動漫故鄉｜柯南灌籃高手新海誠聖地巡禮 | Kawatool',
      ...
      },
      {
        ...
        seoTitle: '昭和大正復古漫遊 | Kawatool',
        seoDescription: '以時光滑桿對比現代東京與昭和街景，感受暖橘木質色調與復古膠片顆粒的懷舊浪漫氛圍。',
        seoKeywords: '昭和復古,大正浪漫,東京街景,純喫茶,Kawatool',
      },
      {
        slug: 'yokai',
        title: '妖怪百鬼夜行',
        ...
        seoTitle: '妖怪百鬼夜行圖鑑 | Kawatool',
        seoDescription: '以手電筒聚光效果探索隱藏妖怪圖形，沉浸式體驗日本都市傳說與百鬼夜行氛圍。',
        seoKeywords: '妖怪,百鬼夜行,都市傳說,日本怪談,Kawatool',
      },
      {
        slug: 'yokocho',
        title: '深夜橫丁',
        ...
        seoTitle: '深夜橫丁居酒屋音景 | Kawatool',
        seoDescription: '暖燈籠光與手繪菜單氛圍，切換雨聲、鐵板滋滋與杯盞碰撞，沉浸深夜橫丁居酒屋療癒音景。',
        seoKeywords: '橫丁,居酒屋,環境音,日本巷弄,Kawatool',
      },
      {
        slug: 'gourmet',
        title: 'B級美食地圖',
        ...
        seoTitle: '在地B級美食地圖 | Kawatool',
        seoDescription: '依地區與預算篩選名古屋手羽先、博多拉麵、大阪章魚燒等庶民傳奇，晴黃高對比美食卡一目了然。',
      ...
      },
      {
        ...
        seoTitle: '隱世溫泉與町家旅宿 | Kawatool',
        seoDescription: '侘寂質感導覽京都町家、歷史旅館與秘境木屋。卡片支援日夜氛圍預覽與分類平滑捲動。',
        seoKeywords: '町家,溫泉旅館,秘境住宿,京都民宿,Kawatool',
      },
    ],
  },
  {
