...
const CATEGORY_DIRS = [
  ...
  'culture', 'symbols', 'spiritual', 'creator', 'viral', 'live', 'cosmos', 'finance', 'world', 'japan', 'scripture',
  'toeic', 'toefl',
];
...
const SLUG_EXTRAS = {
  ...
  'cosmos-black-hole': ['cosmos-theme.js'],
  'cosmos-jwst': ['cosmos-theme.js'],
  'cosmos-exoplanet': ['cosmos-theme.js'],
  'cosmos-mars': ['cosmos-theme.js'],
  'cosmos-artemis': ['cosmos-theme.js'],
  'cosmos-dark-matter': ['cosmos-theme.js'],
  'cosmos-big-bang': ['cosmos-theme.js'],
  'cosmos-neutron-star': ['cosmos-theme.js'],
  'cosmos-supernova': ['cosmos-theme.js'],
  'cosmos-asteroid': ['cosmos-theme.js'],
  'cosmos-gravitational-wave': ['cosmos-theme.js'],
  'cosmos-solar-storm': ['cosmos-theme.js'],
  'cosmos-andromeda': ['cosmos-theme.js'],
  'cosmos-multiverse': ['cosmos-theme.js'],
  'cosmos-wormhole': ['cosmos-theme.js'],
  'cosmos-frb': ['cosmos-theme.js'],
  'cosmos-fate': ['cosmos-theme.js'],
  'cosmos-interstellar': ['cosmos-theme.js'],
  'cosmos-mining': ['cosmos-theme.js'],
  'cosmos-dyson': ['cosmos-theme.js'],
  'stock-fee-calc': ['finance-tools.js'],
  'dividend-yield': ['finance-tools.js'],
  'margin-trading': ['finance-tools.js'],
  'compound-interest': ['finance-tools.js'],
  'percentage-calculator': ['traffic-tools.js'],
  'line-break-remover': ['traffic-tools.js'],
  'image-resizer': ['traffic-tools.js'],
  'heic-to-jpg': ['traffic-tools.js'],
  'svg-to-png': ['traffic-tools.js'],
